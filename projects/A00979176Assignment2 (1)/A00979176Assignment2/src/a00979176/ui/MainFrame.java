...
public class MainFrame extends JFrame {
	...
	public MainFrame() {
		...
		setTitle("Rodrigo`s Silva Motorcycle Centre");
		...
		JMenuItem mntmnventory = new JMenuItem("Inventory");
		mntmnventory.addActionListener(new ActionListener() {
			@Override
			public void actionPerformed(ActionEvent arg0) {
		...
		mntmnventory.setAccelerator(KeyStroke.getKeyStroke(KeyEvent.VK_I, InputEvent.ALT_MASK));
		mnData.add(mntmnventory);
		
		JMenuItem mntmMotorcycle = new JMenuItem("Motorcycle");
		mntmMotorcycle.addActionListener(new ActionListener() {
			@Override
			public void actionPerformed(ActionEvent arg0) {
				LOG.info("Motorcycle menu item pressed.");
				MotorcycleDialog dialog = new MotorcycleDialog();
				dialog.setVisible(true);
			}
		});
		mntmMotorcycle.setAccelerator(KeyStroke.getKeyStroke(KeyEvent.VK_M, InputEvent.ALT_MASK));
		mnData.add(mntmMotorcycle);

		JMenu mnReports = new JMenu("Inventory Report");
		mnReports.setMnemonic(KeyEvent.VK_I);
		...
		mntmMake.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				String make = JOptionPane.showInputDialog(MainFrame.this, "Please, input the make:", "Filter by make",
		...
		mntmMake.setAccelerator(KeyStroke.getKeyStroke(KeyEvent.VK_A, InputEvent.ALT_MASK));
		...
		mntmAbout.addActionListener(new ActionListener() {
			@Override
			public void actionPerformed(ActionEvent e) {
				JOptionPane.showMessageDialog(MainFrame.this, "Motorcycle Centre\nBy Rodrigo Silva", "About Motorcycle Centre App",
						JOptionPane.INFORMATION_MESSAGE);
			}
		});
