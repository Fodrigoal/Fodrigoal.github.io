...
public class Customer {
	...
	public static class Builder {
		...
		public Builder setPhone(String phone) {
			...
			String[] digits ={phone.substring(0, 3),
					phone.substring(3,6),
					phone.substring(6)};

			String newPhone = phoneFormat.format(digits);
	...
	public String toString() {
		return String.format("%-7s %-44s %-37s %21s %18s", getId(), getLastName() + ", " + getFirstName(), getEmailAddress(), 
				getPhone(), getJoinedDate());
	}
